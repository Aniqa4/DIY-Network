  ...
  return (
    <div className="relative flex items-center justify-center">
      <button
        ...
        className="border border-[#1c1b1b] text-center rounded py-1 px-5"
      >
        Edit
      </button>
      ...
      >
        ...
        >
          ...
          <div className="mb-4">
            ...
            <input type="text" placeholder="Enter blog title" className="w-full border border-gray-300 rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-blue-500" />
          </div>
          ...
          <div className="mb-4">
            ...
            <div className="relative">
              <input placeholder="type ingredients here" className="w-full border border-gray-300 rounded-md p-2 resize-none focus:outline-none focus:ring-2 focus:ring-blue-500" />
          ...
          <div className="mb-4">
            ...
            <textarea placeholder="Write your blog content here" className="w-full border border-gray-300 rounded-md p-2 h-32 resize-none focus:outline-none focus:ring-2 focus:ring-blue-500" />
          </div>
